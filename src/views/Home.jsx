      ...
      >
        ...
        <div className="relative z-10 max-w-[90vw] mx-auto px-5">
          <div className="min-h-[70vh] lg:min-h-[80vh] flex flex-col text-left pb-40 lg:pb-0">
            <h1 className="mt-16 md:mt-60 lg:mt-24 text-3xl md:text-6xl lg:text-7xl font-semibold tracking-wide">
              Experiencia,{" "}
            </h1>
            <h1 className="mt-3 text-3xl md:text-6xl lg:text-7xl font-semibold tracking-wide">
              precisión y{" "}
            </h1>

            <div className="lg:flex items-baseline">
              <h1 className="mt-3 text-3xl md:text-6xl lg:text-7xl font-semibold tracking-wide mr-5">
                tecnología{" "}
              </h1>{" "}
              <h1 className="mt-3 text-xl md:text-4xl lg:text-5xl tracking-wide font-light">
                al servicio del{" "}
              </h1>
            </div>
          ...
          <div className="absolute bottom-8 lg:bottom-4 left-1/2 -translate-x-1/2 z-20 pt-5">
