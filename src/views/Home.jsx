...
const Home = () => {
  return (
    <main className="relative z-10 mt-[12vh] px-5 page-fade-in text-[#fafafa]">
      ...
      <section
        id="home"
        className="relative scroll-mt-[14vh] sm:min-h-full md:min-h-[50vh] lg:min-h-[60vh] 3xl:min-h-screen min-h-screen py-[12vh] border-b border-white/10 overflow-hidden"
      >
        {/* Background */}
        <div
          ...
          style={{
            ...
            backgroundSize: "100% auto", // full width
          }}
        />
      ...
      <section
        id="somos"
        className="scroll-mt-[14vh] min-h-[70vh] py-24 border-b border-white/10"
      >
      ...
      <section
        id="servicios"
        className="scroll-mt-[14vh] min-h-[80vh] py-24 border-b border-white/10"
      >
        <div className="max-w-6xl mx-auto">
          <p className="text-sm uppercase tracking-widest text-[#fafafa]/60">
            Servicios
      ...
      <section
        id="plataforma"
        className="scroll-mt-[14vh] py-24 border-b border-white/10"
      >
        <div className="max-w-6xl mx-auto">
          <p className="text-sm uppercase tracking-widest text-[#fafafa]/60">
            Plataforma
      ...
      <section
        id="clientes"
        className="scroll-mt-[14vh] min-h-[55vh] py-24 border-b border-white/10"
      >
        <div className="max-w-6xl mx-auto">
          <p className="text-sm uppercase tracking-widest text-[#fafafa]/60">
            Clientes
